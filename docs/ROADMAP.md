> **Nowe odpowiedzi z 22.09.2026:** [audyt 20 pytań](DECYZJE_2026-09-22_FORMULARZ_20.md) jest nadrzędny dla rozstrzygniętych kwestii; pytania 5/6/8/13/14/15/16/17/20 nadal otwarte. Tablet „Wspólny” i daty ważności są kierunkiem do doprecyzowania, nie zatwierdzonym pełnym rozwiązaniem. Zatwierdzone: automatyczne kolumny i przewijanie; kopiowanie układu telefonu na start, potem osobny; próg krótkiego/długiego przytrzymania w ustawieniach; trzy odmienne terminy planera; 5 s odliczania wyciągania, inny kod anuluje poprzednie; lokalny katalog z przyszłą synchronizacją; wiele prywatnych profili z osobnymi kluczami; równoległe bankowe powiadomienia i wyciągi w jednej kolejce. Nie utożsamiać akceptacji z wdrożeniem.
...
**Aktualny porządek po audycie 20 odpowiedzi:** (1) utrzymać/zweryfikować istniejący kod beta.5 i SQLite v22 bez ponownego planowania wydanych historii cen; (2) dopracować adaptacyjny panel, próg przytrzymania i niezależny układ profilu „Wspólny” po decyzji o autoryzacji; (3) wyciąganie -1 po regulowanych 5 s z anulowaniem po innym kodzie, bez podwójnych ruchów; (4) katalog rozpoznanych produktów z perspektywą synchronizacji, daty ważności po rozstrzygnięciu partii/opakowań; (5) osobne klucze i role wielu prywatnych profili, wkłady i uzgadnianie bankowe po rozstrzygnięciu semantyki; (6) otwarte scenariusze kalendarza, zakupów, cen, remanentu, magazynu i PV przedstawiać do wyboru na przykładach. Nie przypisywać numerów kolejnych bet przed implementacją i testami.
