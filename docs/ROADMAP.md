> **Aktualizacja stanu, 24.09.2026:** bieżące wydanie testowe to 0.6.0.6 / SQLite v29; funkcje Pojazdów i PayCheck wymagają odbioru telefonu. Pierwszy planowany następny inkrement 0.6.0.7 wprowadza wspólną kolejkę „Do potwierdzenia” bez automatycznej weryfikacji banku. Kolejne etapy 0.6: wyciągi/powiadomienia bankowe po udzieleniu uprawnień i wybraniu banku, dokumenty pojazdu, stabilizacja. Dopiero później 0.7 Ogród/Energia, 0.8 synchronizacja, 0.9 regresje i 1.0 Stable po akceptacji. Starsze datowane nagłówki roadmapy są historią, nie stanem obecnego APK.
