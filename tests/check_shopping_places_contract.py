...
assert 'inputVersion != 22 && inputVersion != 23 && inputVersion != 24 && inputVersion != 25 && inputVersion != DB_VERSION' in backup
assert 'Zakup ma nieistniejące miejsce.' in backup
assert 'Przyjęcie ma nieistniejące miejsce.' in backup
assert "versionCode 67" in gradle and "versionNameSuffix ''" in gradle
