...
assert 'private static final int DB_VERSION = 19;' in backup
assert 'super(context, "edhome-beta-preview.db", null, 19' in main
print("Rotation DB v19, next-assignee history, deletion and backup contract: PASS")
