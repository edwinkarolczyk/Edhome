...
assert '"waste".equals(tasks.getString(1))' in reminder
assert '"waste".equals(task.getString(3))' in reminder
assert 'pref.getBoolean("reminders_enabled", false)' in reminder
