...
assert 'super(context, "edhome-beta-preview.db", null, 13)' in main
assert 'private static final int DB_VERSION = 13;' in backup
assert "newVersion > 13" in main
...
assert "versionName '0.3.6'" in gradle
print("6 themes, 9 tiles, exact preview/drop, restored visibility, icon library and DB v13: PASS")
