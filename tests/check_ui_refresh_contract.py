...
assert 'super(context, "edhome-beta-preview.db", null, 18' in main
assert 'private static final int DB_VERSION = 18;' in backup
assert "newVersion > 18" in main
...
print("6 themes, 9 tiles, exact preview/drop, restored visibility, icon library and DB v18: PASS")
