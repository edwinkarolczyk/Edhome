...
assert 'super(context, "edhome-beta-preview.db", null, 16' in main
assert 'private static final int DB_VERSION = 16;' in backup
assert "newVersion > 16" in main
...
print("6 themes, 9 tiles, exact preview/drop, restored visibility, icon library and DB v16: PASS")
