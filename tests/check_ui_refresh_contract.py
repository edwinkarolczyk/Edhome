...
assert 'super(context, "edhome-beta-preview.db", null, 27' in main
assert 'private static final int DB_VERSION = 28;' in backup
assert "newVersion > 27" in main
...
assert "versionName '0.6.0.5'" in gradle
