...
assert 'versionCode 47' in gradle and "versionNameSuffix '-beta.4'" in gradle
assert 'super(context, "edhome-beta-preview.db", null, 21)' in ui
assert 'DB_VERSION = 21;' in backup
